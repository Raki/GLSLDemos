...
const char* images[] = { "img/landscape.jpg","img/portrait.jpg","img/JohnGreen7.png", "img/Lenna.png","img/prerendered.jpg","img/prerendered.original.jpg" };
const std::vector<std::string> sampleTextures{"img/landscape.jpg","img/portrait.jpg","img/JohnGreen7.png", "img/Lenna.png" ,"img/prerendered.jpg","img/prerendered.original.jpg" };
...
void initGL()
{
    ...
    blendProgram = std::make_shared<GlslProgram>(Utility::readFileContents("shaders/vAspect.glsl"), Utility::readFileContents("shaders/fDiff.glsl"));
...
void renderFrame()
{
    ...
    if(showImgDiff)
        glUniformSubroutinesuiv(GL_FRAGMENT_SHADER, 1, &diffColor);
    else
        glUniformSubroutinesuiv(GL_FRAGMENT_SHADER, 1, &blendColor);
...
void renderImgui()
{
...

    {
        ...
        ImGui::Checkbox("View Img Difference", &showImgDiff);
        if(!showImgDiff)
