...
const char* images[] = { "img/door.png","img/niche.png","img/landscape.jpg","img/portrait.jpg","img/JohnGreen7.png", "img/Lenna.png","img/1_webp_ll.webp"};
const std::vector<std::string> sampleTextures{ "img/door.png","img/niche.png","img/landscape.jpg","img/portrait.jpg","img/JohnGreen7.png", "img/Lenna.png","img/1_webp_ll.webp"};
const char* blendModes[] = {"Basic","PreMultiplied Alpha","Simple PreMultiplied Alpha" };

GLuint normalColor;
GLuint textureColor;
GLuint blendModePMA;
GLuint blendModePMABasic;
GLuint blendModeBasic;
#pragma endregion 
...
void initGL()
{
    ...
    blendProgram = std::make_shared<GlslProgram>(Utility::readFileContents("shaders/vAspect.glsl"), Utility::readFileContents("shaders/fBlendPMAlpha.glsl"));
    ...
    blendModePMA = glGetSubroutineIndex(blendProgram->programID, GL_FRAGMENT_SHADER, "preMulBlend");
    blendModePMABasic = glGetSubroutineIndex(blendProgram->programID, GL_FRAGMENT_SHADER, "preMulBlendBasic");
    blendModeBasic = glGetSubroutineIndex(blendProgram->programID, GL_FRAGMENT_SHADER, "defaultBlend");
...
void renderFrame()
{
    ...
    {
    case 0:
        glUniformSubroutinesuiv(GL_FRAGMENT_SHADER, 1, &blendModeBasic);
        break;
    case 1:
        glUniformSubroutinesuiv(GL_FRAGMENT_SHADER, 1, &blendModePMA);
        break;
    case 2:
        glUniformSubroutinesuiv(GL_FRAGMENT_SHADER, 1, &blendModePMABasic);
        break;
    }

    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, textures.at(0)->texture);
    glActiveTexture(GL_TEXTURE1);
    glBindTexture(GL_TEXTURE_2D, textures.at(1)->texture);
